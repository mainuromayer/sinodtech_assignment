<div class=" container-xxl " data-select2-id="select2-data-198-e71y">
    ...
    <div class="card" data-select2-id="select2-data-197-m5it">
        ...
        <div class="card-body py-4">
            <!--begin::Form-->
            <form id="edit-page-form" method="POST" enctype="multipart/form-data" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                @csrf
                <!--begin::Scroll-->
                <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_page_scroll"
                    ...
                    <div class="fv-row mb-6">
                        ...
                        <input class="form-control form-control-solid" type="text" name="title" placeholder="Enter Title" value="{{ old('title',$page->title ?? '') }}">
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="fv-row mb-6">
                        ...
                        <!--begin::Editor-->
                        <div id="kt_edit_page_content" class="min-h-200px mb-2"></div> <!-- Match this ID with the script -->
                        <input type="hidden" name="text" id="edit_page_content_hidden"> <!-- Match this ID with the script -->
                        <!--end::Editor-->
